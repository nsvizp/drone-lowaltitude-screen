...
async function main() {
  ...
  // ---------- 台账：仓储 / 方舱 / 飞手 ----------
  const warehouses = [
    ['浦东防汛物资仓库', '浦东新区应急管理局', '沙袋 · 救生衣 · 抽水泵', 4680, 6000],
    ['徐汇医疗物资储备点', '徐汇区卫健委', '急救包 · 担架 · 氧气瓶', 2350, 3000],
    ['静安应急食品供应站', '静安区商务委', '饮用水 · 方便食品', 9200, 12000],
    ['杨浦救援装备库', '杨浦区消防救援支队', '破拆工具 · 绳索装备', 1120, 1500],
    ['虹桥综合物资枢纽', '闵行区应急管理局', '帐篷 · 被褥 · 照明设备', 5400, 8000],
    ['张江防疫物资仓', '浦东新区疾控中心', '防护服 · 消杀设备', 3100, 5000],
    ['宝山钢材应急库', '宝山区建管委', '支撑钢梁 · 防护板', 860, 1000],
    ['嘉定燃油储备点', '嘉定区发改委', '柴油 · 汽油 · 发电机油料', 1750, 2000],
    ['松江通信器材库', '松江区科委', '对讲机 · 卫星电话', 640, 1200],
    ['青浦水域救援物资点', '青浦区水务局', '冲锋舟 · 救生圈', 430, 600],
    ['奉贤临时安置物资站', '奉贤区民政局', '折叠床 · 毛毯 · 热食', 2900, 4000],
    ['金山化工应急物资库', '金山区应急管理局', '防化服 · 中和剂', 980, 1500],
  ] as const
  for (let i = 0; i < warehouses.length; i++) {
    const [name, org, items, stock, capacity] = warehouses[i]
    await prisma.warehouse.upsert({
      where: { name },
      create: { id: 5001 + i, name, org, items, stock, capacity },
